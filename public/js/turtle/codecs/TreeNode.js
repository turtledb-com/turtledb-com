...
export class TreeNode {
  ...
  * inOrder (u8aTurtle) {
    ...
    if (codec.getCodecTypeVersion(leftFooter).codecType === codec.getCodecType(TREE_NODE)) {
    ...
    if (codec.getCodecTypeVersion(rightFooter).codecType === codec.getCodecType(TREE_NODE)) {
