import { codecsByName, codecVersionByFooter, TREE_NODE } from './codecs.js'
...
export class TreeNode {
  ...
  * inOrder (u8aTurtle) {
    ...
    if (codecVersionByFooter[leftFooter].codecType === codecsByName[TREE_NODE]) {
    ...
    if (codecVersionByFooter[rightFooter].codecType === codecsByName[TREE_NODE]) {
